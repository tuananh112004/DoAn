...
module.exports = (app) => {
    ...
    app.use(PATH_ADMIN + "/chatbot", authMiddleware.requireAuth, chatbotRoutes);
    ...
    app.use(PATH_ADMIN + "/statistic", authMiddleware.requireAuth, statisticRoutes);

    app.use(PATH_ADMIN + "/order", authMiddleware.requireAuth, require('./order.route'));
}